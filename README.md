...
## Environments
- Preview: https://main--xwalk-sitenew--shilpatty.aem.page/
- Live: https://main--xwalk-sitenew--shilpatty.aem.live/
...
1. Open the `xwalk-sitenew` directory in your favorite IDE and start coding :)
